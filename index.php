    ...
    <div class="sidebar">
        ...
        <div class="content">
            ...
            <div class="main01">
                ...
                <div class="conteudo002">
                    <h1>Bom Dia <?php echo htmlspecialchars($nome_usuario); ?>,</h1>
                </div>
                <div class="graficos">
                    <div class="grafico01">
                        <img src="./graficos/grafico1.PNG" alt="">
                    </div>
                    <br>
                    <div class="grafico02">
                        <img src="./graficos/grafico2.PNG" alt="">
                    </div>
                    <br>
                    <div class="grafico03">
                        <img src="./graficos/grafico3.PNG" alt="">
                    </div>
                </div>
            </div>
        </div>
