            ...
            <div class="main01">
                ...
                <div class="header-botoes">
                    <div class="botoes-Container">
                        <a href="./cadastroCliente.php" class="button">CADASTRAR CLIENTES</a>
                        <a href="./cadastroProdutos.php" class="button">CADASTRAR PRODUTOS</a>
                    </div>
                </div>

                <div class="centralizarImg">
                    <img src="../imgs/fundo01.png" alt="" srcset="" height="100px">
                </div>
